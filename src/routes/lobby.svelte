...
import { addPlayer, dataExists, _logCollection, MTGColllections, advanceCurrentRound } from "../db/database";
...
<button on:click={() => {advanceCurrentRound(); goToPage('pairings')}}>Calculate Pairings</button>