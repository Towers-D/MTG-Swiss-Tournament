...
export declare const defaultCodableReader: CodableReader<any>;
 ...
 */
export declare const DEFAULT_CODABLE_TYPE_PRIORITY = 10;
...
export declare function codableType<Item, Data>(name: string, canHandle: (value: unknown) => value is Item, encode: (data: Item, context: EncodeContext) => Data, decode: (data: Data, context: DecodeContext, referenceId: number | null) => Item, options?: CodableTypeOptions<Item>): CodableType<Item, Data>;
export declare function codableClassType<Class extends AnyClass>(name: string, Class: Class, getConstructorArgs: (instance: InstanceType<Class>) => ConstructorParameters<Class>, options?: CodableTypeOptions<InstanceType<Class>>): CodableType<InstanceType<Class>, ConstructorParameters<Class>>;
